    ...
    \section{Research Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Independently secured over \$200,000 for the lab through fellowships and industry partnership
                \item Frequently communicated results through seminars, conference presentations, open-source software, and publications 
                \item Provided continuous mentorship and collaboration in computational methods with undergraduate and graduate students, post-doctoral researchers, faculty, and external collaborators
            \end{highlights}
        \end{onecolentry}

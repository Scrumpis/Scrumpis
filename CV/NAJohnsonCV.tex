...
\begin{document}
    ...
    \section{Research Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Assembling and annotating \textit{Penstemon fruticosus} genome
                \item Resequencing five additional \textit{Penstemon} species
                \item Investigating evolutionary relationships of floral morphology among \textit{Penstemon spp.} on the genomic level
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Investigating genomic patterns associated with adaptation in weedy plants
                ...
                \item Revealed genomic structural variation associated with herbicide resistance evolution in the agronomic weed \textit{Eleusine indica} using computational approaches
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Independently researched abiotic stress and intraspecific competition of tobacco pollen
    ...
    \section{Teaching and Mentoring Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Guided students through course content with two, hour-long recitation meetings and two hours of open office time weekly            
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Helped junior scientists run P.C.R. and a P.A.G.E. gel
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}       
                \item Guide first-year Ph.D. students (assigned one student annually) through professional and general graduate student life decisions to help them acclimate
                \item Attend group-sponsored meetings to recruit and retain graduate students
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Guided a visiting student conducting comparative of agronomic weeds and crops to find genomic patterns of domestication
                \item Helped students develop programming, computational analysis, and presentation skills
            \end{highlights}
        \end{onecolentry}        

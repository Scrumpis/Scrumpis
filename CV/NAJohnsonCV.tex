...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        %\kern 5.0 pt%
        %\mbox{\hrefWithoutArrow{https://scrumpis.github.io/}{Website: scrumpis.github.io}}%
        %\kern 5.0 pt%
        %\AND%
        \kern 5.0 pt%
    ...
    \section{Education}
        ...
        \begin{samepage} 
            \begin{twocolentry}{
                ...
                \textbf{Michigan State University}, Computational Plant Science Graduate Certificate
            \end{twocolentry}
        \end{samepage} 
    ...
    \section{Research Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Independently developed comparative genomics hypotheses and computational approaches to investigate evolutionary adaptation in weedy plant species
                \item Revealed genomic structural variation associated with herbicide resistance evolution in \textit{Eleusine indica}, advancing understanding of weed adaptation
                \item Authored and maintained containerized, open-source omics research software to enable large-scale, reproducible analyses on HPC systems through integration of Bash, Python, and R-based analytical frameworks, with an emphasis on usability for non-computational biologists
                \item Frequently communicated results through presentations, open-source software, and publications 
                \item Provided continuous mentorship or collaboration in computational biology for undergraduate and graduate students, faculty, and external researchers across diverse disciplines
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Fellowships, Grants, and Awards}
        ...
        \begin{samepage} 
            \begin{twocolentry}{
                ...
                \textbf{Deep Learning Cis-Regulation Research Grant (Renewal)}, BASF Germany
            \end{twocolentry}
        \end{samepage}  
        ...
        \begin{samepage} 
            \begin{twocolentry}{
                ...
                \textbf{Dissertation Completion Fellowship}, College of Natural Sciences, Michigan State University
            \end{twocolentry}
        \end{samepage}  
        ...
        \vspace{0.2 cm}
         ...
         \begin{samepage} 
            \begin{twocolentry}{
                ...
                \textbf{Outstanding Student Award}, Genetics and Genome Sciences Program, Michigan State University
            \end{twocolentry}
        \end{samepage}  
        ...
        \begin{samepage} 
            \begin{twocolentry}{
                ...
                \textbf{Outstanding Scholar Fellowship}, College of Natural Sciences, Michigan State University
            \end{twocolentry}
        \end{samepage}  
    ...
    \section{Conference Presentations}
        ...
        \begin{samepage}
            \begin{twocolentry}{
                ...
                \textbf{Gene regulatory sequence annotation in plants using deep learning}
            \end{twocolentry}

            \vspace{0.10 cm}
            
            \begin{onecolentry}
                \mbox{\textbf{Johnson, N. A.}}, \mbox{Filho, D.}, \mbox{Bernhofer, M.}, \mbox{Islamovic, E.}, \mbox{Murphy, B.}, \& \mbox{Patterson, E. L.}
        ...
        \begin{samepage}
            \begin{twocolentry}{
                ...
                \textbf{Subgenome- and region-specific patterns of molecular evolution in the allohexaploid weed \textit{Chenopodium album} L.}
            \end{twocolentry}
        ...
        \begin{samepage}
            ...
            \begin{onecolentry}
                ...
                \textit{BASF Bioinformatics Seminar}: Oral presentation
            \end{onecolentry}
        \end{samepage}
        ...
        \begin{samepage}
            \begin{twocolentry}{
                ...
                \textbf{Annotating cis-regulatory elements in plants via deep learning}
            \end{twocolentry}
            ...
            \begin{onecolentry}
                ...
                \textit{BASF North American Open Research Alliance 2025}: Oral presentation
            \end{onecolentry}
        \end{samepage}
...
%        \end{samepage}  
    ...
    \section{Additional Volunteer Positions}
        ...
        \begin{samepage} 
            \begin{twocolentry}{
                ...
                \textbf{Peer Reviewer}, Scientific Data -- One article
            \end{twocolentry}
        \end{samepage} 
        ...
        \begin{samepage} 
            \begin{twocolentry}{
                ...
                \textbf{Peer Reviewer}, Plant Communications -- Two articles
            \end{twocolentry}
        \end{samepage} 
    ...
    \section{Software}
        ...
        \begin{samepage}
            ...
            \begin{onecolentry}
                ...
                \textit{R library for scalable calculation and analysis of evolutionary selection pressures}

                \vspace{0.10 cm}
                
                \href{https://github.com/Scrumpis/dndsR}{https://github.com/Scrumpis/dndsR}
            \end{onecolentry}
        \end{samepage}     
        ...
        \begin{samepage}
            ...
            \begin{onecolentry}
                ...
                \textit{Bash pipeline to quickly and easily produce Circos plots for commonly visualized genomic features}

                \vspace{0.10 cm}
                
                \href{https://github.com/Scrumpis/iwgc-circos}{https://github.com/Scrumpis/iwgc-circos}
            \end{onecolentry}
        \end{samepage}            
    ...
    \section{Publications}
        ...
        \begin{samepage}
            ...
            \begin{onecolentry}
                \mbox{Lemas, J., Patterson, E., Cutti, L., Morran, S.,} \mbox{\textbf{Johnson, N. A.}},
                \mbox{Montgomery, J., Abdollahi, F., Nelson, D., Llaca, V., Fengler, K., Westra, P., \& Gaines, T.}
        ...
        \begin{samepage}
            ...
            \begin{onecolentry}
                \mbox{\textbf{Johnson, N. A.}}, \mbox{Lemas, J.}, \mbox{Montgomery, J.}, \mbox{Gaines, T.}, \& \mbox{Patterson, E.}
        ...
        \begin{samepage}
            ...
            \begin{onecolentry}
                \mbox{Palande, S., Arsenault, J., Lozada, P., Bleich, A., Brown, B., Buysee, B., Connors, N., Adhikari, S.,}
                \mbox{Dobson, K., Castillo, F., Carrillo, M., Harlow, S., Orozsco, H., Hightower, A., Izqueirdo, Jacobs, M.,}
                
                \mbox{\textbf{Johnson, N. A.}},
                \mbox{Leuenberger, W., Hernandez, A., Duque, A., Avila, C., Galindo, E., Plancarte, D.,}
                \mbox{Schuster, J., Shomer, H., Sitar, S., Steensma, A., Thomson, J., Amador, A., Waterman, R., Webster, B.,} 
                \mbox{Whyte, M., Azcue, S., Montgomery, B., Husbands, A., Krishnan, A., Percival, S., Munch, E.,}
                \mbox{VanBuren, R., Chitwood, D., \& Rougon-Cardoso, A.}
        ...
        \begin{samepage}
            ...
            \begin{onecolentry}
                \mbox{Zhang, C.}* \& \mbox{\textbf{Johnson, N. A.*}}, \mbox{Hall, N.}, \mbox{Tian, X.}, \mbox{Yu, Q.}, \& \mbox{Patterson, E.}

    ...
    \section{Research Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Revealed genomic structural variation associated with herbicide resistance evolution in the agronomic weed \textit{Eleusine indica} using comparative genomics approaches, advancing understanding of weed adaptation
                \item Developed genomic and evolutionary analysis pipelines (Unix, Python, R) to automate workflows and expand accessibility for non-computational biologists
                \item Frequently communicated results through presentations, open-source software, and publications 
                \item Provided continuous mentorship or collaboration in computational methods with undergraduate and graduate students, post-doctoral researchers, faculty, and external collaborators
            \end{highlights}
        \end{onecolentry}
